...
},{"@ledgerhq/live-app-sdk":27}],5:[function(require,module,exports){
"use strict";
/**
...
class LedgerLivePlatformSDK {
    ...
    listAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            const rawAccounts = yield this._request("account.list");
...
},{"../logger":28,"../serializers":33,"../types":36,"json-rpc-2.0":39}],6:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"bignumber.js":37}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"bignumber.js":37}],9:[function(require,module,exports){
...
},{"bignumber.js":37}],11:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeCryptoOrgTransaction = exports.serializeCryptoOrgTransaction = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const serializeCryptoOrgTransaction = ({ family, mode, fees, amount, recipient, }) => {
    return {
        family,
        amount: amount.toString(),
        recipient,
...
exports.serializeCryptoOrgTransaction = serializeCryptoOrgTransaction;
const deserializeCryptoOrgTransaction = ({ family, mode, fees, amount, recipient, }) => {
    return {
        family,
        amount: new bignumber_js_1.default(amount),
        recipient,
...
exports.deserializeCryptoOrgTransaction = deserializeCryptoOrgTransaction;

},{"bignumber.js":37}],13:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeEthereumTransaction = exports.serializeEthereumTransaction = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
function serializeEthereumTransaction({ family, amount, recipient, nonce, data, gasPrice, gasLimit, }) {
    return {
        family,
        amount: amount.toString(),
        recipient,
...
exports.serializeEthereumTransaction = serializeEthereumTransaction;
function deserializeEthereumTransaction({ family, amount, recipient, nonce, data, gasPrice, gasLimit, }) {
    return {
        family,
        amount: new bignumber_js_1.default(amount),
        recipient,
...
exports.deserializeEthereumTransaction = deserializeEthereumTransaction;

}).call(this)}).call(this,require("buffer").Buffer)
},{"bignumber.js":37,"buffer":2}],15:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
},{"bignumber.js":37}],17:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeRippleTransaction = exports.serializeRippleTransaction = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const serializeRippleTransaction = ({ family, fee, tag, amount, recipient, }) => {
    return {
        family,
        amount: amount.toString(),
        recipient,
...
exports.serializeRippleTransaction = serializeRippleTransaction;
const deserializeRippleTransaction = ({ family, fee, tag, amount, recipient, }) => {
    return {
        family,
        amount: new bignumber_js_1.default(amount),
        recipient,
...
exports.deserializeRippleTransaction = deserializeRippleTransaction;

},{"bignumber.js":37}],19:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeStellarTransaction = exports.serializeStellarTransaction = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const serializeStellarTransaction = ({ amount, recipient, family, fees, memoType, memoValue, }) => {
    return {
        amount: amount.toString(),
        recipient,
        family,
...
exports.serializeStellarTransaction = serializeStellarTransaction;
const deserializeStellarTransaction = ({ amount, recipient, family, fees, memoType, memoValue, }) => {
    return {
        amount: new bignumber_js_1.default(amount),
        recipient,
        family,
...
exports.deserializeStellarTransaction = deserializeStellarTransaction;

},{"bignumber.js":37}],21:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
},{"bignumber.js":37}],23:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeTronTransaction = exports.serializeTronTransaction = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const serializeTronTransaction = ({ amount, recipient, family, mode, resource, duration, }) => {
    return {
        amount: amount.toString(),
        recipient,
        family,
...
exports.serializeTronTransaction = serializeTronTransaction;
const deserializeTronTransaction = ({ amount, recipient, family, mode, resource, duration, }) => {
    return {
        amount: new bignumber_js_1.default(amount),
        recipient,
        family,
...
exports.deserializeTronTransaction = deserializeTronTransaction;

},{"bignumber.js":37}],25:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
var FAMILIES;
(function (FAMILIES) {
    FAMILIES["BITCOIN"] = "bitcoin";
    FAMILIES["ETHEREUM"] = "ethereum";
    FAMILIES["ALGORAND"] = "algorand";
    FAMILIES["CRYPTO_ORG"] = "crypto_org";
    FAMILIES["RIPPLE"] = "ripple";
    FAMILIES["COSMOS"] = "cosmos";
    FAMILIES["TEZOS"] = "tezos";
    FAMILIES["POLKADOT"] = "polkadot";
    FAMILIES["STELLAR"] = "stellar";
    FAMILIES["TRON"] = "tron";
})(FAMILIES || (FAMILIES = {}));
exports.default = FAMILIES;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = exports.Mock = exports.FAMILIES = void 0;
/* istanbul ignore file */
__exportStar(require("./types"), exports);
__exportStar(require("./rawTypes"), exports);
__exportStar(require("./families/ethereum/types"), exports);
__exportStar(require("./families/bitcoin/types"), exports);
__exportStar(require("./families/algorand/types"), exports);
__exportStar(require("./families/cosmos/types"), exports);
__exportStar(require("./families/crypto_org/types"), exports);
__exportStar(require("./families/polkadot/types"), exports);
__exportStar(require("./families/ripple/types"), exports);
__exportStar(require("./families/stellar/types"), exports);
__exportStar(require("./families/tezos/types"), exports);
__exportStar(require("./families/tron/types"), exports);
var types_1 = require("./families/types");
Object.defineProperty(exports, "FAMILIES", { enumerable: true, get: function () { return __importDefault(types_1).default; } });
var mock_1 = require("./mock");
Object.defineProperty(exports, "Mock", { enumerable: true, get: function () { return __importDefault(mock_1).default; } });
__exportStar(require("./transports"), exports);
__exportStar(require("./serializers"), exports);
var LedgerLivePlatformSDK_1 = require("./LedgerLivePlatformSDK");
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return __importDefault(LedgerLivePlatformSDK_1).default; } });

},{"./LedgerLivePlatformSDK":5,"./families/algorand/types":7,"./families/bitcoin/types":9,"./families/cosmos/types":11,"./families/crypto_org/types":13,"./families/ethereum/types":15,"./families/polkadot/types":17,"./families/ripple/types":19,"./families/stellar/types":21,"./families/tezos/types":23,"./families/tron/types":25,"./families/types":26,"./mock":30,"./rawTypes":32,"./serializers":33,"./transports":34,"./types":36}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/* istanbul ignore file */
class Logger {
...
Object.defineProperty(exports, "__esModule", { value: true });
/* istanbul ignore file */
const generateRandomTxID = (length) => {
    const result = [];
...
exports.default = generateRandomTxID;
...
},{"../serializers":33,"./generateRandomTxID":29,"./mocks.json":31}],31:[function(require,module,exports){
module.exports={
    "rawCurrencies": [
        {
            "type": "CryptoCurrency",
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deserializeTransaction = exports.serializeTransaction = exports.deserializeAccount = exports.serializeAccount = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const serializer_1 = require("./families/algorand/serializer");
const serializer_2 = require("./families/bitcoin/serializer");
const serializer_3 = require("./families/cosmos/serializer");
const serializer_4 = require("./families/crypto_org/serializer");
const serializer_5 = require("./families/ethereum/serializer");
const serializer_6 = require("./families/polkadot/serializer");
const serializer_7 = require("./families/ripple/serializer");
const serializer_8 = require("./families/stellar/serializer");
const serializer_9 = require("./families/tezos/serializer");
const serializer_10 = require("./families/tron/serializer");
const types_1 = __importDefault(require("./families/types"));
/**
...
},{"./families/algorand/serializer":6,"./families/bitcoin/serializer":8,"./families/cosmos/serializer":10,"./families/crypto_org/serializer":12,"./families/ethereum/serializer":14,"./families/polkadot/serializer":16,"./families/ripple/serializer":18,"./families/stellar/serializer":20,"./families/tezos/serializer":22,"./families/tron/serializer":24,"./families/types":26,"bignumber.js":37}],34:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.WindowMessageTransport = void 0;
/* istanbul ignore file */
// eslint-disable-next-line import/prefer-default-export
var windowMessageTransport_1 = require("./windowMessageTransport");
Object.defineProperty(exports, "WindowMessageTransport", { enumerable: true, get: function () { return __importDefault(windowMessageTransport_1).default; } });

},{"./windowMessageTransport":35}],35:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
const logger_1 = __importDefault(require("../logger"));
const defaultLogger = new logger_1.default("WindowMessage");
class WindowMessageTransport {
    constructor(target = window, logger = defaultLogger) {
        this.connect = () => {
            ...
            // @ts-ignore (FIXME)
            (_a = this.target.document) === null || _a === void 0 ? void 0 : _a.addEventListener("message", this._onMessageEvent, false);
        ...
        this.disconnect = () => {
            ...
            // @ts-ignore (FIXME)
            (_a = this.target.document) === null || _a === void 0 ? void 0 : _a.removeEventListener("message", this._onMessageEvent, false);
...
},{"../logger":28}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ExchangeType = exports.DeviceModel = exports.FeesLevel = void 0;
/**
...
(function (FeesLevel) {
    ...
    FeesLevel["Fast"] = "fast";
})(FeesLevel = exports.FeesLevel || (exports.FeesLevel = {}));
var DeviceModel;
...
},{"./internal":40,"./models":41}],39:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./client":38,"./models":41,"./server":43,"./server-and-client":42}],40:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./models":41}],43:[function(require,module,exports){
"use strict";
